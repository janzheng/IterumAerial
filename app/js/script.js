...
// - can link to a # of another page, and smooth-scroll down to that #
  ...
  // http://stackoverflow.com/questions/28605591/prevent-html5-videos-from-downloading-the-files-on-mobile-videojs
  ...
  $(document).ready(function() {
    ...
    $('a').fluidbox({
      ...
      $('a').on('openstart.fluidbox', function(){
        $('.intro').addClass('_fade')
      });
      $('a').on('closestart.fluidbox', function(){
        $('.intro').removeClass('_fade')
      });
    ...
    $('._toggle').on('click', function() {
      var target = $('.' + this.getAttribute('data-src'));
      // if(target.hasClass('_hidden'))
